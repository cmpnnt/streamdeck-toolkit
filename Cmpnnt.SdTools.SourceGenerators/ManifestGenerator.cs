...
{
    private const string COMMON_PLUGIN_FUNCTIONS = "Cmpnnt.SdTools.Backend.ICommonPluginFunctions";
    private const string KEYPAD_PLUGIN = "Cmpnnt.SdTools.Backend.IKeypadPlugin";
    private const string ENCODER_PLUGIN = "Cmpnnt.SdTools.Backend.IEncoderPlugin";
