...
{
    private const string SdSettingsAttrFqn       = "Cmpnnt.SdTools.Attributes.SdSettingsAttribute";
    private const string JsonPropNameAttrFqn      = "System.Text.Json.Serialization.JsonPropertyNameAttribute";
    private const string FilenameAttrFqn          = "Cmpnnt.SdTools.Attributes.FilenamePropertyAttribute";
        ...
        IReadOnlyList<SettingsProp> properties)
    {
        ...
        sb.AppendLine("using Cmpnnt.SdTools;");
        sb.AppendLine();
