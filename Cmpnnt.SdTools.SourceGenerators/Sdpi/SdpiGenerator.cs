...
using Cmpnnt.SdTools.SourceGenerators.Sdpi.Templates;
using Cmpnnt.SdTools.SourceGenerators.Sdpi.Utils;
using Microsoft.CodeAnalysis;
using Microsoft.CodeAnalysis.CSharp.Syntax;
using Microsoft.CodeAnalysis.Text;

namespace Cmpnnt.SdTools.SourceGenerators.Sdpi;

[Generator]
public class SdpiGenerator : IIncrementalGenerator
{
    private const string TEXT_AREA_FULL_NAME = "Cmpnnt.SdTools.Components.TextArea";
    private const string TEXTFIELD_FULL_NAME = "Cmpnnt.SdTools.Components.Textfield";
    private const string CHECKBOX_FULL_NAME = "Cmpnnt.SdTools.Components.Checkbox";
    private const string CHECKBOX_LIST_FULL_NAME = "Cmpnnt.SdTools.Components.CheckboxList";
    private const string BUTTON_FULL_NAME = "Cmpnnt.SdTools.Components.Button";
    private const string DATE_FULL_NAME = "Cmpnnt.SdTools.Components.Calendar.Date";
    private const string DATETIME_FULL_NAME = "Cmpnnt.SdTools.Components.Calendar.DateTime";
    private const string MONTH_FULL_NAME = "Cmpnnt.SdTools.Components.Calendar.Month";
    private const string TIME_FULL_NAME = "Cmpnnt.SdTools.Components.Calendar.Time";
    private const string WEEK_FULL_NAME = "Cmpnnt.SdTools.Components.Calendar.Week";
    private const string COLOR_FULL_NAME = "Cmpnnt.SdTools.Components.Color";
    private const string DELEGATE_FULL_NAME = "Cmpnnt.SdTools.Components.Delegate";
    private const string FILE_FULL_NAME = "Cmpnnt.SdTools.Components.File";
    private const string PASSWORD_FULL_NAME = "Cmpnnt.SdTools.Components.Password";
    private const string RADIO_FULL_NAME = "Cmpnnt.SdTools.Components.Radio";
    private const string RANGE_FULL_NAME = "Cmpnnt.SdTools.Components.Range";
    private const string SELECT_FULL_NAME = "Cmpnnt.SdTools.Components.Select";
    private const string SDPI_OUTPUT_ATTRIBUTE_FULL_NAME = "Cmpnnt.SdTools.Attributes.SdpiOutputDirectoryAttribute";
