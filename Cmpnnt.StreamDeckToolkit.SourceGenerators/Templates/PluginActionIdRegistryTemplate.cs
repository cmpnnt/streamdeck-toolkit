...
using System;
using Cmpnnt.StreamDeckToolkit;
...
namespace Cmpnnt.StreamDeckToolkit.SourceGenerators
{
    ...
    {
        private static readonly FrozenDictionary<string, Func<IOutboundConnection, InitialPayload, ICommonPluginFunctions>> _actionFactories = CreateFactories();
        ...
        private static FrozenDictionary<string, Func<IOutboundConnection, InitialPayload, ICommonPluginFunctions>> CreateFactories()
        {
            var factories = new Dictionary<string, Func<IOutboundConnection, InitialPayload, ICommonPluginFunctions>>()
            {");
