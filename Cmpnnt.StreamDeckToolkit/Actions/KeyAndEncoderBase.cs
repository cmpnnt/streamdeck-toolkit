...
{
    /// <summary>
    /// Main abstract class your plugin should derive from for actions that support both keys and dials.
    /// For keys only use KeypadBase. For dials only use EncoderBase.
    /// </summary>
    public abstract class KeyAndEncoderBase : IKeypadPlugin, IEncoderPlugin
    {
        ...
        public KeyAndEncoderBase(IOutboundConnection connection, InitialPayload payload)
